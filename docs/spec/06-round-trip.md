...
| Groups | Represented | `div[data-group]` nested | child coordinates in group space; translation, nonuniform scale, rotation and flips compose through ancestors; `chOff/chExt` recomputed on touch without rescaling children |
